...
% Получить, ожидаюющих игру, игроков
%get_wait_players() ->
%	gen_server:call( ?MODULE, {get_wait_players}).

% Согласие на игру
%consent_play( PlayerPid, ConsentPlayerID ) ->
%	gen_server:call( ?MODULE, {consent, PlayerPid, ConsentPlayerID }).
...
% ----------- Получить wait-game пользователей -----------------
